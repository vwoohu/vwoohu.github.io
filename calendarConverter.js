...
var route, posOrigen, posDestino, posDerecho, posIzquierdo, posNumOrigen, posNumDestino, posNumDerecho, posNumIzquierdo, posNumNacimiento, ci, cj;
...
var MAYAN_TZOLKIN_MONTHS = new Array("Imox", "Iq'", "Aq'ab'al", "K'at", "Kan",
...
/*  updateFromGregorian  --  Update all calendars from Gregorian.
                             ...
                             calendars.  */
var chumil = new Array("Imox", "Iq'", "Aq'ab'al", "K'at", "Kan",
                       "Kame", "Kej", "Q'anil", "Toj", "Tz'i'",
                       "B'atz'", "E", "Aj", "I'x", "Tz'ikin",
                       "Ajmaq", "No'j", "Tijax", "Kawoq", "Ajpu");
...
//  Change Ch'umil Images

    route = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 1] + ".jpg";
    document.getElementsByName("centro")[0].src = route;
    document.getElementsByName("centro")[0].title = chumil[maytzolkincal[0] - 1];
    document.getElementsByName("centro")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 1];

    if (maytzolkincal[0]>=9 && maytzolkincal[0]<=12) {
        posOrigen = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 9] + ".jpg";
        document.getElementsByName("origen")[0].src = posOrigen;
        document.getElementsByName("origen")[0].title = chumil[maytzolkincal[0] - 9];
        document.getElementsByName("origen")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 9];

        posDestino = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] + 7] + ".jpg";
        document.getElementsByName("destino")[0].src = posDestino;
        document.getElementsByName("destino")[0].title = chumil[maytzolkincal[0] + 7];
        document.getElementsByName("destino")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] + 7];

        posDerecho = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 7] + ".jpg";
        document.getElementsByName("derecho")[0].src = posDerecho;
        document.getElementsByName("derecho")[0].title = chumil[maytzolkincal[0] - 7];
        document.getElementsByName("derecho")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 7];

        posIzquierdo = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] + 5] + ".jpg";
        document.getElementsByName("izquierdo")[0].src = posIzquierdo;
        document.getElementsByName("izquierdo")[0].title = chumil[maytzolkincal[0] + 5];
        document.getElementsByName("izquierdo")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] + 5];
    } else if (maytzolkincal[0]<=8) {
        cj = 19 - (8 - maytzolkincal[0]);

        posOrigen = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[cj] + ".jpg";
        document.getElementsByName("origen")[0].src = posOrigen;
        document.getElementsByName("origen")[0].title = chumil[cj];
        document.getElementsByName("origen")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[cj];
        ...
        if (maytzolkincal[0]==8 || maytzolkincal[0]==7) {
            posDerecho = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 7] + ".jpg";
            document.getElementsByName("derecho")[0].src = posDerecho;
            document.getElementsByName("derecho")[0].title = chumil[maytzolkincal[0] - 7];
            document.getElementsByName("derecho")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] - 7];

        } else if (maytzolkincal[0]<=6) {
            ci = 19-(6 - maytzolkincal[0]);

            posDerecho = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[ci] + ".jpg";
            document.getElementsByName("derecho")[0].src = posDerecho;
            document.getElementsByName("derecho")[0].title = chumil[ci];
            document.getElementsByName("derecho")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[ci];
        }
    } else if (maytzolkincal[0]>=13) {
        cj = maytzolkincal[0] - 13;
        ...
        posDestino = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[cj] + ".jpg";
        document.getElementsByName("destino")[0].src = posDestino;
        document.getElementsByName("destino")[0].title = chumil[cj];
        document.getElementsByName("destino")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[cj];
        ...
        if (maytzolkincal[0]==13 || maytzolkincal[0]==14) {
            posIzquierdo = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] + 5] + ".jpg";
            document.getElementsByName("izquierdo")[0].src = posIzquierdo;
            document.getElementsByName("izquierdo")[0].title = chumil[maytzolkincal[0] + 5];
            document.getElementsByName("izquierdo")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[maytzolkincal[0] + 5];

        } else if (maytzolkincal[0]>=15) {
            ci = maytzolkincal[0] - 15;

            posIzquierdo = "http://sacredroad.org/wp-content/uploads/calcimages/" + MAYAN_TZOLKIN_MONTHS[ci] + ".jpg";
            document.getElementsByName("izquierdo")[0].src = posIzquierdo;
            document.getElementsByName("izquierdo")[0].title = chumil[ci];
            document.getElementsByName("izquierdo")[0].alt = "Nawal " + MAYAN_TZOLKIN_MONTHS[ci];
        }
    }

    // Change Number Images

    route = "http://sacredroad.org/wp-content/uploads/calcimages/" + maytzolkincal[1] + ".png";
	document.getElementsByName("numnacimiento")[0].src = route;
    document.getElementsByName("numnacimiento")[0].alt = "Number " + maytzolkincal[1];

    if (maytzolkincal[1]>=1 && maytzolkincal[1]<=5) {
    	posNumOrigen = 13 - (8 - maytzolkincal[1]);
    	posNumDestino = maytzolkincal[1] + 8;
    	posNumIzquierdo = maytzolkincal[1] + 6;
    	posNumDerecho = 13 - (6 - maytzolkincal[1]);
    } else if (maytzolkincal[1]>=6 && maytzolkincal[1]<=8) {
    ...
    } else if (maytzolkincal[1]>=9 || maytzolkincal[1]<=13) {
		posNumOrigen = maytzolkincal[1] - 8;
    	posNumDestino = maytzolkincal[1] - 5;
    	posNumIzquierdo = maytzolkincal[1] - 7;
    	posNumDerecho = maytzolkincal[1] - 6;
    }

    route = "http://sacredroad.org/wp-content/uploads/calcimages/" + posNumOrigen + ".png";
	document.getElementsByName("numorigen")[0].src = route;
    document.getElementsByName("numorigen")[0].alt = "Number " + posNumOrigen;

    route = "http://sacredroad.org/wp-content/uploads/calcimages/" + posNumDestino + ".png";
	document.getElementsByName("numdestino")[0].src = route;
    document.getElementsByName("numdestino")[0].alt = "Number " + posNumDestino;

    route = "http://sacredroad.org/wp-content/uploads/calcimages/" + posNumIzquierdo + ".png";
	document.getElementsByName("numizquierdo")[0].src = route;
    document.getElementsByName("numizquierdo")[0].alt = "Number " + posNumIzquierdo;

    route = "http://sacredroad.org/wp-content/uploads/calcimages/" + posNumDerecho + ".png";
	document.getElementsByName("numderecho")[0].src = route;
    document.getElementsByName("numderecho")[0].alt = "Number " + posNumDerecho;

    /*if (maytzolkincal[1]>=1 && maytzolkincal[1]<=5) {
    	route = "http://sacredroad.org/wp-content/uploads/calcimages/" + (maytzolkincal[1]+8) + ".png";
		document.getElementsByName("numdestino")[0].src = route;
    	document.getElementsByName("numdestino")[0].alt = "Number " + (maytzolkincal[1]+8);

    	route = "http://sacredroad.org/wp-content/uploads/calcimages/" + (maytzolkincal[1]+6) + ".png";
		document.getElementsByName("numizquierdo")[0].src = route;
    	document.getElementsByName("numizquierdo")[0].alt = "Number " + (maytzolkincal[1]+6);
    ...
    } else if (maytzolkincal[1]>=6 && maytzolkincal[1]<=13) {
